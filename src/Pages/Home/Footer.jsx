    ...
    return (
        ...
        <div className='bg-black w-screen'>
            ...
            <div>
                ...
                <p className='w-[19rem] leading-10 text-sm lg:text-lg'>Lorem ipsum dolor sit amet consectetur. Mi nibh venenatis in suscipit turpis enim cursus vulputate amet. Lobortis mi platea aliquam senectus tempus mauris neque.</p>
            </div>
...
<div className='flex lg:flex-row flex-col lg:gap-40 items-center gap-10'>
            <div>
                ...
                <select className='lg:hidden text-sm bg-black text-white rounded-sm' name="" id="">
            ...
            <h2 className='text-gray-500 text-center py-3'>Copyright nHub 2024. All right reserved</h2>
        </div>
        </>
    )
}
